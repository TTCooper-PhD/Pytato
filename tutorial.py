...
input_folder="Target_Folder\mzML"
...
print(f"Identified {len(firstbake_proteins)} High-confidence proteins in First Bake....")
firstbake_fasta=filter_fasta(fasta_file,"Test.fasta",firstbake_proteins)
print(firstbake_fasta)
firstbake_fasta="Test.fasta"
#Search_Enzyme2_withEnzyme1_Library
report_file_name="toppings"
run_dia_nn(dia_nn_exe_path, library_files, firstbake_fasta, input_folder, output_folder,report_file_name=report_file_name, qval=0.1,threads=30,missed_cleavages=2,
